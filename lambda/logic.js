...
const convertPokemonResponse = (handlerInput, response, timezone) => {
    ...
    results.forEach((pokemon, index) => {
        ...
        speechResponse += pokemon.name.value;
        if (timezone && pokemon.height.value) {
            speechResponse += t('POKEMON_HEIGHT_AND_WEIGHT', {height: pokemon.height.value, weight: pokemon.weight.value, name: pokemon.name.value });
        }
